"""
Go Digital! AI Chatbot — webový server.
Používá FastAPI + Groq API (cloud LLM) + znalostní bázi o Go Digital!.
"""
...
if not GROQ_API_KEY:
    ...
    print("   Vytvořte soubor .env ve složce go_digital_bot/ s obsahem:")
...
def get_system_prompt() -> str:
    ...
    return f"""Jsi přátelský a profesionální zákaznický asistent společnosti Go Digital! a.s.
Odpovídáš na otázky zákazníků o firmě Go Digital!, jejích službách, pobočkách a kontaktech.
...
Pokud odpověď neznáš, doporuč kontaktovat Go Digital! přímo.
...
app = FastAPI(title="Go Digital! Chatbot")
...
if __name__ == "__main__":
    ...
    print(f"🚀 Go Digital! Chatbot startuje na http://localhost:{port}")
